...
Advertencia:
- Si el usuario responde con "1", "agroquimico", "quimico", "principio activo" número con emojis (ej. "1️⃣"), se interpretará como que el usuario quiere terminar la transaccion con un agroquimico, ira 1 en el campo "Eleccion".
- Si el usuario responde con "2", "Efectivo", "dinero", "plata" o número con emojis (ej. "2️⃣"), se interpretará como que el usuario quiere terminar la transaccion con dinero, ira 2 en el campo "Eleccion".
